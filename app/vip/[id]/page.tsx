...
export default function VipB2BPropertyPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0A0A0A] font-sans selection:bg-amber-500 selection:text-slate-900 pb-24">
            <Toaster position="bottom-center" richColors theme="dark" />

            {/* 0. BARRA DE NAVEGACIÓN VIP */}
            <div className="fixed top-0 left-0 w-full bg-black/80 backdrop-blur-xl border-b border-white/5 z-50 px-6 py-4 flex justify-between items-center">
            ...
            {/* 1. CABECERA HERO TÁCTICA */}
            <div className="relative w-full h-[55vh] sm:h-[65vh] bg-black overflow-hidden mt-14">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-8 relative z-10 -mt-2">
                ...
                {/* 💰 LA BÓVEDA B2B (EL GANCHO FINANCIERO) */}
