            ...
            <div className={`${isExpanded ? 'col-span-4 space-y-8' : 'w-full space-y-6'}`}>
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-white/70 text-sm leading-relaxed">
                        Este activo representa una oportunidad única. Reformado por <strong>Arkibio</strong>.
                    </p>
                </div>

                <button className="w-full bg-white text-black font-bold py-5 rounded-xl flex items-center justify-center gap-3 transition-transform hover:scale-[1.02] shadow-[0_0_30px_rgba(255,255,255,0.2)]">
                    {data.type === 'live' ? (
                        <>
                            <Fingerprint className="w-6 h-6" />
                            <span className="tracking-wider">DESBLOQUEAR</span>
                        </>
                    ) : (
